...
if USER=="old":
    ...
    if st.button("Login"):
        response = requests.post("http://127.0.0.1:5050/login", json={"email": user_email, "password": hashed_password})
    ...
    if st.button("Register"):
         response1 = requests.post("http://127.0.0.1:5050/register",json={"first_name":first_name,"last_name":last_name,"phone":phone,"email":user_email,"hashed_password":hashed_password})
